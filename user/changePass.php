<?php
    ...
    if(isset($_POST, $_SESSION['fyp_userData'])){
        ...
        if($newPassword == $confirm_Password){
            ...
            if($oldPassword == $_SESSION['fyp_userData']['password']){
                ...
                if($run){
                    ...
                    ';
                    $_SESSION['fyp_userData']['password'] = $newPassword;
                ...
                $_SESSION['msg'] = '
                    <div class="alert alert-danger alert-dismissible fade show">
                        <button type="button"  onclick="window.location.reload()" class="close" data-dismiss="alert">&times;</button>
                        <strong>Process fail!</strong> Please Write Correct Current Password
                    </div>
                ';
                header('location:'.$_SERVER['HTTP_REFERER']);
            }
