...
<body style="background-color: grey">
    ...
    <div class="p-5" id="content">
      ...
      if (isset($_GET['jobPost'])) :
        ...
        $query = "SELECT * FROM `jobpost` WHERE postID = '$jobPost' ORDER BY sdate DESC";
      ...
      ?>
            <a href="index.php" class="btn btn-info col-xl-1 m-2">go back</a>
            <div class="card-header text-center"><?= $postData['jtitle']; ?></div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-12">
                            <div class="headings d-flex justify-content-between align-items-center mb-3">
                                <h5 class="text-center text-navy" style="font-weight:bold;"><?= $postData['jtitle'];  ?>
                                </h5>
                            </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="user d-flex flex-row align-items-center">
                                        start date &nbsp; <small> <span class="text-muted">
                                                <?= date('d F. Y', strtotime($postData['sdate'])); ?> </span> </small>
                                        &nbsp;
                            ...
                            <div>
                                <div class="col-md-12">
                                    ...
                                    <div class="action d-flex justify-content-between mt-2 align-items-center">
                                        <div class="reply px-">
                                            <a class="btn btn-info text-link" href="registration.php"> <small> Apply now
                                                </small></a>
                                        </div>
                                    </div>
                                </div>
          ...
          echo "<h5 style='color:red; text-align:center;'> BAD ACCESS METHOD</h5>";
        endif;
          ?>
                </div>
            </div>
